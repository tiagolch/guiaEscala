...
class Escala(models.Model):
    ...
    funcao = models.ForeignKey(Funcao, on_delete=models.DO_NOTHING, verbose_name='Função', unique=True)
    evento = models.ForeignKey(Evento, on_delete=models.DO_NOTHING, verbose_name='Evento', unique=True)
